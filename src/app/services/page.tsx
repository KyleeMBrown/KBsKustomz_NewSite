...
const page = () => {
    return (
        <>
            {/* Greyscale Image */}
            <div className="w-full h-[85vh] max-[380px]:h-screen grayscale text-white bg-[url('/images/ServiceBG-min.jpeg')] bg-no-repeat bg-center bg-cover">
                {/*  Gradient Overlay */}    
                <div className='w-full h-full flex items-center justify-center bg-linear-to-br from-31% from-black'>
                    ...
                    <div className="w-[90%] h-full flex items-start pl-[4em] max-[768px]:pl-0 justify-center flex-col">
                        <h1 className="max-[768px]:w-full max-[768px]:mb-[0.5em] mb-[0.75em] text-4xl font-bold max-[768px]:text-2xl max-[380px]:text-[1.5em]">Custom Paint & Auto Body Services <br></br>Wyanet, IL</h1>
                        ...
                        <div className='max-[768px]:flex-col flex items-start justify-center gap-4 text-black'>
                            <div className="p-3 hover:scale-104 transition-all ease-in flex flex-col gap-[0.5em] drop-shadow-md items-start justify-center bg-white w-[20em] max-[768px]:w-full">
                                <Image className="max-[768px]:w-[8%] max-[420px]:hidden" fetchPriority='high' width={40} height={40} alt="Paint Can" src="/images/paint-bucket.svg"/>
                            ...
                            <div className="p-3 hover:scale-104 transition-all ease-in pr-1.5 flex flex-col gap-[0.5em] drop-shadow-md items-start justify-center bg-white w-[20em] max-[768px]:w-full">
                                <Image className="max-[768px]:w-[8%] max-[420px]:hidden" fetchPriority='high' width={40} height={40} alt="Paint Can" src="/images/car-front-fill.svg"/>
