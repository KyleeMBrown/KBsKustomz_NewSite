...
const Hero = (): React.JSX.Element => {
  ...
  return (
    <div className='w-full h-[85vh] max-[768px]:flex-col text-white flex items-center justify-center bg-black'>
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5877.589673270109!2d-89.59097!3d41.387959!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88098fe3e725c8bf%3A0x2ae78e393bcc4d23!2sKB&#39;s%20Kustomz!5e1!3m2!1sen!2sus!4v1766447386026!5m2!1sen!2sus" width="600" height="450" className="rounded-xl max-[768px]:h-[22em] max-[768px]:w-[90%] max-[380px]:h-[15em] max-[380px]:w-[85%]"></iframe>        
          </div>
    </div>
  )
}
