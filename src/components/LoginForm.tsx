...
export function LoginForm({
  ...
  const [hidden, setHidden]:[boolean, Dispatch<SetStateAction<boolean>>] = useState<boolean>(true)
  ...
  const [err, setErr]:[AuthApiError, Dispatch<SetStateAction<AuthApiError>>] = useState<AuthApiError>();
