    ...
    return (
      <>
        ...
        <div className="w-full mb-2">
         ...
         {/* TABLE WRAPPER */}
      <div className="h-[38.5em] max-[768px]:h-[35em] max-[440px]:h-[46em] max-[415px]:h-[40em]  max-[400px]:h-[43em] max-[380px]:h-[35em]  max-[376px]:h-[32em] max-[350px]:h-[45em]  max-[330px]:h-[32em] overflow-y-auto bg-[#150a04] relative max-[768px]:overflow-x-hidden  rounded-md border no-scrollbar">
        {/* TABLE */}
