...
export const columns: ColumnDef<Images>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <>
        <svg key={row.id} xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-trash cursor-pointer hover:fill-red-600 p-2 border border-transparent hover:border-red-600 rounded" viewBox="0 0 16 16">
